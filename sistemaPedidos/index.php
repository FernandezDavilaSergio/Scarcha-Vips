...
if (!empty($_SESSION['active'])) {
    ...
    if (!empty($_POST)) {
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            ...
            $clave = md5(mysqli_real_escape_string($conexion, $_POST['clave'])); // Se debe evitar usar md5 para el hash de contraseñas, pero manteneré la misma lógica que en el código original
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-secondary btn-user" data-toggle="modal" data-target="#modalAgregarCliente">
                                            Agregar Cliente
                                        </button>
                                    </div>
                                </div>
